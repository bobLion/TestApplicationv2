...
public class FlikerProgressBar extends View implements Runnable {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            textSize = (int) ta.getDimension(R.styleable.FlikerProgressBar_filk_textSize, 12);
            ...
            radius = (int) ta.getDimension(R.styleable.FlikerProgressBar_filk_radius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.FlikerProgressBar_filk_borderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
