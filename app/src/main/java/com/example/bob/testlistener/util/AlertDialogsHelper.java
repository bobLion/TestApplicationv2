...
import com.example.bob.testlistener.activity.ThemedActivity;
import com.example.bob.testlistener.adapter.ProgressAdapter;
import com.example.bob.testlistener.data.Media;
import com.example.bob.testlistener.data.metadata.MediaDetailsMap;
import com.example.bob.testlistener.data.metadata.MetadataHelper;
...
public class AlertDialogsHelper {
    ...
    public static AlertDialog getTextDialog(ThemedActivity activity, @StringRes int title, @StringRes int Message){
        ...
        TextView dialogTitle = (TextView)dialogLayout.findViewById(R.id.text_dialog_title);
        TextView progressMessage = (TextView)dialogLayout.findViewById(R.id.name_folder);
        ((ProgressBar) dialogLayout.findViewById(R.id.progress_dialog_loading)).getIndeterminateDrawable()
        ...
        RecyclerView rv = (RecyclerView)dialogLayout.findViewById(R.id.rv_progress);
