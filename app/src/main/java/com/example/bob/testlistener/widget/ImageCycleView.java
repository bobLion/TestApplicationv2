...
import com.example.bob.testlistener.fragment.CycleViewPager;
...
//			Glide.with(mContext).load(mAdList.get(position).getImgId()).into(imageView);
//			imageView.setImageResource(mAdList.get(position).getImgId());
